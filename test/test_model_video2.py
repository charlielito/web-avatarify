...
if __name__ == "__main__":
    ...
    source_image = cv2.imread("avatars/apipe.jpg")[..., ::-1]
    ...
    fps = 30
    driving_video = get_frames_from_camera(0)
    ...
    if opt.find_best_frame or opt.best_frame is not None:
        i = (
            ...
            else find_best_frame(source_image, driving_video, cpu=opt.cpu)
        )
    ...
    imageio.mimsave(
        opt.result_video, [img_as_ubyte(frame) for frame in predictions], fps=fps
    )
